...
The graphviz binary will also need to be downloaded and installed. See the official [Graphviz page](https://graphviz.org/download/) to learn how to download and install graphviz for your machine.
